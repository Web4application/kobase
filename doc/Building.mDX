...
```
git clone https://github.com/web4application/koreader.git
...
```
make KOR_BASE=../kobase
```

This will be handy if you are developing `**kobase**` and you want to test your
...
To automatically set up a number of **``kodev``** primarily `luarocks-related `environment variables:
```lua
./kodev activate
```
